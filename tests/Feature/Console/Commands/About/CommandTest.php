...
namespace Tests\Feature\Playground\Make\Request\Console\Commands\About;

use PHPUnit\Framework\Attributes\CoversClass;
use Playground\Test\OrchestraTestCase;

/**
 * \Tests\Feature\Playground\Make\Request\Console\Commands\About
 */
#[CoversClass(\Playground\Make\Request\ServiceProvider::class)]
class CommandTest extends OrchestraTestCase
{
    ...
    public function test_command_about_displays_package_information_and_succeed_with_code_0(): void
    {
        ...
        $result->expectsOutputToContain('Playground: Make Request');
    }
}
