...
namespace Playground\Make\Request;
...
/**
 * \Playground\Make\Request\ServiceProvider
 */
class ServiceProvider extends AuthServiceProvider
{
    public const VERSION = '73.0.0';

    public string $package = 'playground-make-request';
    ...
    public function register(): void
    {
        $this->mergeConfigFrom(
            dirname(__DIR__).'/config/playground-make-request.php',
    ...
    public function about(): void
    {
        ...
        AboutCommand::add('Playground: Make Request', fn () => [
